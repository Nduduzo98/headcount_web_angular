...
@Component({
  selector: 'app-west-submission-stat',
  templateUrl: './west-submission-stat.component.html',
  styleUrls: ['./west-submission-stat.component.scss']
})
export class WestSubmissionStatComponent {
