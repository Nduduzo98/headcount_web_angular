...
@Component({
  selector: 'app-east-submission-stat',
  templateUrl: './east-submission-stat.component.html',
  styleUrls: ['./east-submission-stat.component.scss']
})
export class EastSubmissionStatComponent {
