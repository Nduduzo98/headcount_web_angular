...
@Component({
  selector: 'app-north-submission-stat',
  templateUrl: './north-submission-stat.component.html',
  styleUrls: ['./north-submission-stat.component.scss']
})
export class NorthSubmissionStatComponent {
