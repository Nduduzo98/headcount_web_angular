...
@Component({
  selector: 'app-north-inprogress',
  templateUrl: './north-inprogress.component.html',
  styleUrls: ['./north-inprogress.component.scss']
})
export class NorthInprogressComponent {
  roles: string | null;
  currentUser: any;
