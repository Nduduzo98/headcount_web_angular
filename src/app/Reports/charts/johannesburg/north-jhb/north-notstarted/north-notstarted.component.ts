...
@Component({
  selector: 'app-north-notstarted',
  templateUrl: './north-notstarted.component.html',
  styleUrls: ['./north-notstarted.component.scss']
})
export class NorthNotstartedComponent {
  roles: string | null;
  currentUser: any;
