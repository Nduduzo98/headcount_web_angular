...
@Component({
  selector: 'app-south-inprogress',
  templateUrl: './south-inprogress.component.html',
  styleUrls: ['./south-inprogress.component.scss']
})
export class SouthInprogressComponent {
  roles: string | null;
  currentUser: any;
