...
@Component({
  selector: 'app-south-notstarted',
  templateUrl: './south-notstarted.component.html',
  styleUrls: ['./south-notstarted.component.scss']
})
export class SouthNotstartedComponent {
