...
@Component({
  selector: 'app-south-submission-stat',
  templateUrl: './south-submission-stat.component.html',
  styleUrls: ['./south-submission-stat.component.scss']
})
export class SouthSubmissionStatComponent {
