...
@Component({
  selector: 'app-central-notstarted',
  templateUrl: './central-notstarted.component.html',
  styleUrls: ['./central-notstarted.component.scss']
})
export class CentralNotstartedComponent {
  roles: string | null;
  currentUser: any;
