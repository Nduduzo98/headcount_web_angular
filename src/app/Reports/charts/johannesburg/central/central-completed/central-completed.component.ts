...
@Component({
  selector: 'app-central-completed',
  templateUrl: './central-completed.component.html',
  styleUrls: ['./central-completed.component.scss']
})
export class CentralCompletedComponent {
  roles: string | null;
  currentUser: any;
