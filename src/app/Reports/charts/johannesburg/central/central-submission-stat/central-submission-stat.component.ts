...
@Component({
  selector: 'app-central-submission-stat',
  templateUrl: './central-submission-stat.component.html',
  styleUrls: ['./central-submission-stat.component.scss']
})
export class CentralSubmissionStatComponent {
