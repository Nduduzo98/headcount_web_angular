...
@Component({
  selector: 'app-central-inprogress',
  templateUrl: './central-inprogress.component.html',
  styleUrls: ['./central-inprogress.component.scss']
})
export class CentralInprogressComponent {
  roles: string | null;
  currentUser: any;
