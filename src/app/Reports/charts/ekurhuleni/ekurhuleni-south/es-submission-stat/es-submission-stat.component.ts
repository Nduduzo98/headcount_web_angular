...
@Component({
  selector: 'app-es-submission-stat',
  templateUrl: './es-submission-stat.component.html',
  styleUrls: ['./es-submission-stat.component.scss']
})
export class EsSubmissionStatComponent {
