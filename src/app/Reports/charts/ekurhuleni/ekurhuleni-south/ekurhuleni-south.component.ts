...
@Component({
  selector: 'app-ekurhuleni-south',
  templateUrl: './ekurhuleni-south.component.html',
  styleUrls: ['./ekurhuleni-south.component.scss']
})
export class EkurhuleniSouthComponent {
