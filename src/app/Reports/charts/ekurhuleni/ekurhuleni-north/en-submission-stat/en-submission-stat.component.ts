...
@Component({
  selector: 'app-en-submission-stat',
  templateUrl: './en-submission-stat.component.html',
  styleUrls: ['./en-submission-stat.component.scss']
})
export class EnSubmissionStatComponent {
