...
@Component({
  selector: 'app-gn-submission-stat',
  templateUrl: './gn-submission-stat.component.html',
  styleUrls: ['./gn-submission-stat.component.scss']
})
export class GnSubmissionStatComponent {
