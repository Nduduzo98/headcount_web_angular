...
@Component({
  selector: 'app-sw-submission-stat',
  templateUrl: './sw-submission-stat.component.html',
  styleUrls: ['./sw-submission-stat.component.scss']
})
export class SwSubmissionStatComponent {
