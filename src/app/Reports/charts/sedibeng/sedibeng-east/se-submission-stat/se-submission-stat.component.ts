...
@Component({
  selector: 'app-se-submission-stat',
  templateUrl: './se-submission-stat.component.html',
  styleUrls: ['./se-submission-stat.component.scss']
})
export class SeSubmissionStatComponent {
