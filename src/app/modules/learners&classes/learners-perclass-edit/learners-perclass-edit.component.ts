...
@Component({
  selector: 'app-learners-perclass-edit',
  templateUrl: './learners-perclass-edit.component.html',
  styleUrls: ['./learners-perclass-edit.component.scss']
})
export class LearnersPerclassEditComponent implements OnInit {
...
constructor(private head:HeadCountServiceService, private formBuilder:FormBuilder,
  private ref:MatDialogRef<LearnersPerclassEditComponent>,private toast: NgToastService, private lookup:LookupService, private router:Router,@Inject(MAT_DIALOG_DATA) public data :any) {
...
ngOnInit(): void {
  ...
  this.learnersPerclassForm = this.formBuilder.group({
    ...
    preGradeRMale: [null,[Validators.min(0)]],
      ...
      preGradeRTotal:  [null,[validateNumberBelow1000,Validators.min(0)]],
      preGradeRClasses: [null,[numberBelow30,Validators.min(0)]],
      gradeRMale: [null,[Validators.min(0)]],
      gradeRFemale: [null,[Validators.min(0)]],
      gradeRTotal:  [null,[validateNumberBelow1000,Validators.min(0)]],
      gradeRClasses: [null,[numberBelow30,Validators.min(0)]],
      malesTotal:  [null,[Validators.min(0)]],
      femalesTotal:  [null,[Validators.min(0)]],
      classesTotal:  [null,[Validators.min(0)]],
      statusID: 1,
      gradeMale1: [null,[Validators.min(0)]],
      gradeFemale1: [null,[Validators.min(0)]],
      gradeTotal1:  [null,[validateNumberBelow1000]],
      gradeClasses1: [null,[numberBelow30,Validators.min(0)]],
      gradeMale2: [null,[Validators.min(0)]],
      gradeFemale2: [null,[Validators.min(0)]],
      gradeTotal2:  [null,[validateNumberBelow1000]],
      gradeClasses2: [null,[numberBelow30,Validators.min(0)]],
      gradeMale3: [null,[Validators.min(0)]],
      gradeFemale3: [null,[Validators.min(0)]],
      gradeTotal3:  [null,[validateNumberBelow1000]],
      gradeClasses3: [null,[numberBelow30,Validators.min(0)]],
      gradeMale4: [null,[Validators.min(0)]],
      gradeFemale4: [null,[Validators.min(0)]],
      gradeTotal4:  [null,[validateNumberBelow1000]],
      gradeClasses4: [null,[numberBelow30,Validators.min(0)]],
      gradeMale5: [null,[Validators.min(0)]],
      gradeFemale5: [null,[Validators.min(0)]],
      gradeTotal5:  [null,[validateNumberBelow1000]],
      gradeClasses5: [null,[numberBelow30,Validators.min(0)]],
      gradeMale6: [null,[Validators.min(0)]],
      gradeFemale6: [null,[Validators.min(0)]],
      gradeTotal6:  [null,[validateNumberBelow1000]],
      gradeClasses6: [null,[numberBelow30,Validators.min(0)]],
      gradeMale7: [null,[Validators.min(0)]],
      gradeFemale7: [null,[Validators.min(0)]],
      gradeTotal7:  [null,[validateNumberBelow1000]],
      gradeClasses7: [null,[numberBelow30,Validators.min(0)]],
      gradeMale8: [null,[Validators.min(0)]],
      gradeFemale8: [null,[Validators.min(0)]],
      gradeTotal8:  [null,[validateNumberBelow1000]],
      gradeClasses8: [null,[numberBelow30,Validators.min(0)]],
      gradeMale9: [null,[Validators.min(0)]],
      gradeFemale9: [null,[Validators.min(0)]],
      gradeTotal9:  [null,[validateNumberBelow1000]],
      gradeClasses9: [null,[numberBelow30,Validators.min(0)]],
      gradeMale10: [null,[Validators.min(0)]],
      gradeFemale10: [null,[Validators.min(0)]],
      gradeTotal10:  [null,[validateNumberBelow1000]],
      gradeClasses10: [null,[numberBelow30,Validators.min(0)]],
      gradeMale11: [null,[Validators.min(0)]],
      gradeFemale11: [null,[Validators.min(0)]],
      gradeTotal11:  [null,[validateNumberBelow1000]],
      gradeClasses11: [null,[numberBelow30,Validators.min(0)]],
      gradeMale12: [null,[Validators.min(0)]],
      gradeFemale12: [null,[Validators.min(0)]],
      gradeTotal12:  [null,[validateNumberBelow1000]],
      gradeClasses12: [null,[numberBelow30,Validators.min(0)]],
      gradeMaleSpecial: [null,[Validators.min(0)]],
      gradeFemaleSpecial: [null,[Validators.min(0)]],
      gradeTotalSpecial:  [null,[validateNumberBelow1000]],
      gradeClassesSpecial: [null,[numberBelow30,Validators.min(0)]],
      gradeMaleOther: [null,[Validators.min(0)]],
      gradeFemaleOther: [null,[Validators.min(0)]],
      gradeTotalOther:  [null,[validateNumberBelow1000]],
      gradeClassesOther: [null,[numberBelow30,Validators.min(0)]],
      LearnersTotal:[null,[Validators.min(0)]]
  ...
  this.learnersPerclassForm.patchValue(this.data)
...
onSubmit(){
  if (this.learnersPerclassForm.valid) {
    console.log(this.learnersPerclassForm.value);

    this.head.UpdateSurveyDetails(this.data.id,this.learnersPerclassForm.value).subscribe({
      next:(res) => {
        console.log(res);
